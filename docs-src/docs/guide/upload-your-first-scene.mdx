...
You have successfully followed the [Quickstart](./quickstart.mdx) guide and have the `kognic-io` library installed.
...
See the [Motion Compensation](/docs/kognic-io/scenes/lidars_with_imu_data.md) section for more details.
:::
...
- [View your scene](./view-uploaded-scene.mdx) in the Kognic Platform
- [Key concepts](/docs/key_concepts.md): Learn about the key concepts of the Kognic Platform
- [Scenes](/docs/kognic-io/overview): Dive deeper into scenes and how to work with them
- [Calibrations](/docs/kognic-io/calibrations/overview): Learn how to create and manage calibrations
- [Sending scene for annotation](/docs/kognic-io/working_with_scenes_and_inputs#creating-inputs-from-scene): Learn how to send a scene for annotation
