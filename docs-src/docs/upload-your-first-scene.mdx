...
This guide will walk you through the process of uploading your first scene, either 2D or 3D.
...
- [Scenes](./kognic-io/scenes/overview): Learn how to interact with scenes on the Kognic Platform
- [Sending scene for annotation](./working_with_scenes_and_inputs#creating-inputs-from-scene): Learn how to send a scene for annotation
