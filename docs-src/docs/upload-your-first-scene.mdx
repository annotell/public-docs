...
You have successfully followed the [Quickstart](./quickstart.mdx) guide and have the `kognic-io` client installed.

<details style={{backgroundColor: 'white', borderColor: 'var(--kognic-lavender)'}}>
  <summary>
    <h2 style={{margin: 0}}>Uploading a 2D scene</h2>
  </summary>
...
<details style={{backgroundColor: 'white', borderColor: 'var(--kognic-lavender)'}}>
  <summary>
    <h2 style={{margin: 0}}>Uploading a 2D/3D scene</h2>
  </summary>
